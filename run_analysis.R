...
#### y_train.txt, subject_test.txt, X_test.txt and y_test.txt from the unzipped "UCI HAR Dataset" folder have been copied to
#### a local directory called tidydata, and the working directory in R has been set to this directory, tidydata. 
